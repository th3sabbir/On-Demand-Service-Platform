			...
			<div class="col-md-12 col-12">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb justify-content-center mb-0">
						...
						<li class="breadcrumb-item active" aria-current="page">{{ __('LeadsInfo')}}</li>
					</ol>
				</nav>
			</div>
		</div>
								...
								<div class="card-header">
									<div class="row align-items-center">
										...
										<div class="book-submit">
											<a href="{{ (Auth::user()->user_type == 3) ? route('user.leads') : route('provider.dashboard') }}" class="btn btn-dark"><i class="feather-arrow-left-circle"></i>  {{__('Go to Leads')}}</a>
